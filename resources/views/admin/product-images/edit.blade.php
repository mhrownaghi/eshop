    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                <!--begin::Row-->
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Edit Product Image Setting ({{ $productImage->product->name }})</h3></div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.products.index') }}">Products</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.product-images.index', $productImage->product->slug) }}">Product Images</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Product Image Setting</li>
                        </ol>
                    </div>
                </div>
                <!--end::Row-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch" id="is-thumb"
                                       name="is_thumb" @checked(old('is_thumb', $productImage->is_thumb))>
                                <label class="form-check-label" for="is-active">Thumb</label>
                                @error('is_thumb')
                                <div id="is-thumbFeedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                            </div>
