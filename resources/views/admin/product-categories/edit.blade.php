    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                <!--begin::Row-->
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Edit Product Category</h3></div>
                    <div class="col-sm-6">
        ...
        <div class="app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form action="{{ route('admin.product-categories.update', $productCategory->slug) }}" method="POST">
                        <!-- /.card-header -->
                        <div class="card-body">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch" id="is-active"
                                       name="is_active" @checked(old('is_active', $productCategory->is_active))>
                                ...
                                <div>
                                    <select
                                        ...
                                        @foreach ($productCategories as $item)
                                            <option
                                                value="{{ $item->id }}"
                                                @selected(old('parent_id', $productCategory->parent_id) == $item->id)>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="d-flex column-gap-2 align-items-center flex-wrap mb-3">
                                ...
                                <div>
                                    <textarea
                                        ...
                                        rows="3"
                                        cols="100">{{ old('meta_description', $productCategory->meta_description) }}</textarea>
                                </div>
                            </div>
